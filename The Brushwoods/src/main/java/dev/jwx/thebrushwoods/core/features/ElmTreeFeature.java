...
public class ElmTreeFeature extends Feature<ElmTreeFeature.ElmTreeConfiguration> {
    
    public static final Codec<ElmTreeConfiguration> CODEC = RecordCodecBuilder.create((p_225468_) -> {
        ...
        })).apply(p_225468_, ElmTreeConfiguration::new);
    });
    
    public ElmTreeFeature(Codec<ElmTreeConfiguration> pCodec) {
        super(pCodec);
    }
    
    @Override
    public boolean place(FeaturePlaceContext<ElmTreeConfiguration> pContext) {
        FancyCanopyTreeGenerator.create(pContext.level(), pContext.origin());
        return true;
    }
    
    static class ElmTreeConfiguration extends TreeConfiguration {
    
        protected ElmTreeConfiguration(BlockStateProvider p_225457_, TrunkPlacer p_225458_, BlockStateProvider p_225459_, FoliagePlacer p_225460_, Optional<RootPlacer> p_225461_, BlockStateProvider p_225462_, FeatureSize p_225463_, List<TreeDecorator> p_225464_, boolean p_225465_, boolean p_225466_) {
